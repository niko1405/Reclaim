...
[plantuml,app-profile-router,svg]
----
include::app-profile-router.plantuml[]
----
...
[plantuml,app-profile-write-router,svg]
----
include::app-profile-write-router.plantuml[]
----
...
."AppProfileService" von der Geschäftslogik
[plantuml,AppProfileService,svg]
----
include::AppProfileService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."AppProfileWriteService" von der Geschäftslogik
[plantuml,AppProfileWriteService,svg]
----
include::AppProfileWriteService.plantuml[]
----
